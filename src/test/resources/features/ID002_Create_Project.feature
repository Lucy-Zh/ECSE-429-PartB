...
Given the REST API To-Do List Manager application is running
  ...
  Scenario: Create a new project with title (Normal Flow)
...
And the response status code should be 201
  ...
  Scenario: Create a new project without title (Alternate Flow)
...
And the response status code should be 201
  ...
  Scenario: Create a new project with invalid data format (Error Flow)
