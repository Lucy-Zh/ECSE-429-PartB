...
Scenario: Delete an existing project by id (Normal Flow)
...
Scenario: Delete an existing project with no title (Alternate Flow)
...
Scenario: Delete an nonexistent project (Error Flow)
