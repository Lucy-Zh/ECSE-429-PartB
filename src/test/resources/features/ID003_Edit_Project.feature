...
Scenario: Edit the title of an existing project (Normal Flow)
...
Scenario: Edit an the description of an existing project (Alternate Flow)
...
Scenario: Edit an the complete status of an existing project (Alternate Flow)
...
Scenario: Edit an the active status of an existing project (Alternate Flow)
...
Scenario: Edit an nonexistent project (Error Flow)
...
Scenario: Edit an existing project with invalid data format (Error Flow)
